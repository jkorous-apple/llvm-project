...
static void canonicalizeForCaching(llvm::cas::ObjectStore &CAS,
...
llvm::Optional<llvm::cas::CASID> clang::canonicalizeAndCreateCacheKey(
  ...
  canonicalizeForCaching(CAS, Diags, Invocation, WriteOutputAsCASID);
...
clang::createCompileJobCacheKey(ObjectStore &CAS, DiagnosticsEngine &Diags,
  ...
  bool WriteOutputAsCASID; // Ignored
  canonicalizeForCaching(CAS, Diags, CI, WriteOutputAsCASID);
